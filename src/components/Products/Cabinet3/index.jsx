...
import new_prod5 from '../../../imgs/new_prod5.jpg';
            ...
            <Grid container className={`${classes.paperContainer}`}>
                ...
                <Zoom>
                    <div className="paper-container-media">
                        ...
                        <div className={classes.indentPoints}>
                            <Typography variant="body2" gutterBottom className={classes.content}>
                            ► Compact, durable and solid MS cabinet (2’ x 4’).
                            </Typography>
                            <Typography variant="body2" gutterBottom className={classes.content}>
                            ► European Standard UV-C 99W bulb 
                            </Typography>
                            <Typography variant="body2" gutterBottom className={classes.content}>
                ...
                <Grid item xs={12} sm={6}>
                    <div className={"containerBuyNow"}>
                        <img src={new_prod5} alt="machine" className={classes.img} />
